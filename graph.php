      ...
      load.style.display='none';
        ...
        <table>
            <tbody>
                <tr>
                    <td>
                        <div style="height: 265px; width: 400px; border-style: solid; border-color: black;">
                        <canvas id="myChart0" width="400" height="265"></canvas>
                        </div>
                    </td>
                    <td>
                        <div style="height: 265px; width: 400px; border-style: solid; border-color: black;">
                        <canvas id="myChart" width="400" height="265"></canvas>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div style="height: 265px; width: 400px; border-style: solid; border-color: black;">
                        <canvas id="myChart1" width="400" height="265"></canvas>
                        </div>
                    </td>
                    <td>
                        <div style="height: 265px; width: 400px; border-style: solid; border-color: black;">
                        <canvas id="myChart2" width="400" height="265"></canvas>
                        </div>
                    </td>
                </tr>
            </tbody>
